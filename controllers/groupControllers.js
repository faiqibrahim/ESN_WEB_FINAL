...
angular.module('esn')
    .controller('CreateGroupCtrl', function ($scope, $http, $location) {
        ...
        $scope.create_group = function () {
            ...
            $http.post('http://imadevelopers.com/esn/groups/add.json', $formData, {withCredentials: true})
        ...
        var getAuthInfo = function () {
            ...
            return $http.get('http://imadevelopers.com/esn/groups/getUserInfo/' + $routeParams.groupId + '.json', {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
        ...
        $scope.joinGroup = function () {
            ...
            $http.post('http://imadevelopers.com/esn/group_users/add.json', $formData, {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
        ...
        $scope.unJoinGroup = function () {
            $scope.joiningGroup = true;
            var $group_id = $scope.Group.id;
            $http.delete('http://imadevelopers.com/esn/group_users/delete/' + $group_id + '.json', {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
                        $scope.groupJoined = false;
                        $scope.joiningGroup = false;
        ...
        $scope.cancelRequest = function () {
            ...
            if ($scope.groupRequested)
                $http.delete('http://imadevelopers.com/esn/group_users/deleteRequest/' + $group_id + '.json', {withCredentials: true})
                    .success(function (data) {
                        if (data.result.success) {
                            $scope.groupRequested = false;
                            $scope.joiningGroup = false;
    ...
    .controller('GroupMenuController', function ($scope) {
        ...
        var updateAnnouncements = function () {
            ...
            $http.post('http://imadevelopers.com/esn/announcements/getByGroup/' + $scope.Group.id + '.json', {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
                        $scope.loadingAnnouncements = false;
        ...
        $scope.addAnnouncement = function () {
            ...
            $http.post('http://imadevelopers.com/esn/announcements/add.json', $formData, {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
        ...
        $scope.deleteAnnouncement = function ($announcement_id, $index) {
            $http.delete('http://imadevelopers.com/esn/announcements/delete/' + $announcement_id + '.json', {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
        ...
        var updatePosts = function () {
            ...
            $http.post('http://imadevelopers.com/esn/posts/findByGroup/' + $scope.Group.id + '.json', {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
                        $scope.loadingGroupPosts = false;
        ...
        $scope.uploadfile = function () {
            ...
            var uploadUrl = 'http://imadevelopers.com/esn/contents/uploadFile.json';
        ...
        $scope.addPost = function () {
            ...
            $http.post('http://imadevelopers.com/esn/posts/add.json', $formData, {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
        ...
        $scope.savePost = function ($post, $index) {
            ...
            $http.post('http://imadevelopers.com/esn/posts/edit/' + $post.id + '.json', {'Post': $post}, {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
                        editable_post_id = -1;
        ...
        $scope.deletePost = function (id, $index) {
            $http.delete('http://imadevelopers.com/esn/posts/delete/' + id + '.json', {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
    ...
    controller('GroupEditPostController', function ($scope, $http, fileUpload) {
        ...
        var updateQuestions = function () {
            ...
            $http.post('http://imadevelopers.com/esn/questions/getByGroup/' + $scope.Group.id + '.json', {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
                        $scope.loadingQuestions = false;
        ...
        $scope.addQuestion = function () {
            ...
            $http.post('http://imadevelopers.com/esn/questions/add.json', $formData, {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {

                        var $question = data.result.question;
                        $scope.data.questions.unshift($question);
                    } else
                        console.log(data);
                }).error(function (error) {
                    console.log(error);
        ...
        $scope.viewAnswers = function (id) {
            $http.get('http://imadevelopers.com/esn/answers/findByQuestion/' + id + '.json', {withCredentials: true})
                .success(function (data) {
                    if (data.result.success)
        ...
        $scope.addAnswer = function (question_id, new_answer) {
            ...
            $http.post('http://imadevelopers.com/esn/answers/add.json', $formData, {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
        ...
        var loadUsers = function () {
            ...
            $http.get('http://imadevelopers.com/esn/groups/getUsers/' + $scope.Group.id + '.json', {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
        ...
        $scope.removeUser = function ($user_id, $index) {
            ...
            $http.delete('http://imadevelopers.com/esn/groups/deleteUser/' + $user_id + '/' + $scope.Group.id + '.json', {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
    ...
    .controller('GroupContentsController', function ($scope, $http, $Auth, fileUpload) {
        ...
        var loadContent = function () {
            ...
            $http.get('http://imadevelopers.com/esn/groupcontents/getByGroup/' + $scope.Group.id + '.json', {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
        ...
        $scope.addContent = function () {
            ...
            $http.post('http://imadevelopers.com/esn/groupcontents/add.json', $formData, {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
        ...
        $scope.deleteContent = function (id, $index) {
            $http.delete('http://imadevelopers.com/esn/groupcontents/delete/' + id + '.json', {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
    ...
    .controller('GroupTasksController', function ($scope, $http, $Auth, fileUpload, $interval) {
        ...
        $interval(function () {
            ...
            if ($scope.data.view == './views/group/tasks.html')
                if (getTime) {
                    getTime = false;
                    $http.get('http://imadevelopers.com/esn/tasks/gettime.json')
                        .success(function (data) {
                            if (data.result.success) {
        ...
        var loadTasks = function () {
            ...
            $http.get('http://imadevelopers.com/esn/tasks/getbygroup/' + $scope.Group.id + '.json', {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
        ...
        $scope.createTask = function () {
            ...
            $http.post('http://imadevelopers.com/esn/tasks/add.json', $formData, {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
        ...
        $scope.submitSolution = function (task_id) {
            ...
            if ($scope.resubmit) {
                ...
                $http.post('http://imadevelopers.com/esn/solutions/edit/' + $scope.solution_id + '.json', $formData, {withCredentials: true})
                    .success(function (data) {
                        console.log(data);
                ...
                $http.post('http://imadevelopers.com/esn/solutions/add.json', $formData, {withCredentials: true})
                    .success(function (data) {
                        console.log(data);
                        if (data.result.success) {
                            $scope.solutionUploaded = true;
        ...
        if (!angular.isUndefined($task_id)) {
            $http.post('http://imadevelopers.com/esn/solutions/getByTask/' + $task_id + '.json', {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
        ...
        var loadRequests = function () {
            ...
            $http.get('http://imadevelopers.com/esn/groups/getrequests/' + $scope.Group.id + '.json', {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
        ...
        $scope.acceptRequest = function ($JoinRequest, $index) {
            ...
            $http.post('http://imadevelopers.com/esn/groups/acceptRequest.json', $formData, {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
        ...
        $scope.rejectRequest = function ($JoinRequest, $index) {
            ...
            $http.post('http://imadevelopers.com/esn/groups/rejectRequest.json', $formData, {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
                        $scope.data.requests.splice($index, 1);
                        $scope.processingRequest = false;
        ...
        $scope.form.selectedInterest = null;
        var $group = {};
        $http.get('http://imadevelopers.com/esn/groups/getById/' + $routeParams.group_id + '.json', {withCredentials: true})
            .success(function (data) {
        ...
        $scope.deleteInterest = function (id, $index) {
            $http.delete('http://imadevelopers.com/esn/groups/deleteInterest/' + id + '/' + $routeParams.group_id + '.json', {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
        ...
        $scope.edit_group = function () {
            var $formData = getFormJson();
            $http.post('http://imadevelopers.com/esn/groups/edit/' + $routeParams.group_id + '.json', $formData, {withCredentials: true})
                .success(function (data) {
                    console.log(data);
                    if (data.result.success) {
