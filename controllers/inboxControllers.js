...
angular.module('esn')
    ...
    .controller('InboxMenuController', function ($scope) {
        ...
        var loadData = function () {
            ...
            $http.get('http://imadevelopers.com/esn/chats/getSummary.json', {withCredentials: true})
        ...
        var loadChat = function () {
            ...
            $http.post('http://imadevelopers.com/esn/chats/getchat/' + $routeParams.contactId + '.json', {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
        ...
        $scope.sendMessage = function () {
            ...
            if ($contact_id != null) {
                ...
                $http.post('http://imadevelopers.com/esn/chats/addMessage.json', $formData, {withCredentials: true})
                    .success(function (data) {
                        if (data.result.success) {
                            $scope.new_message = '';
                            $scope.$broadcast('rebuild:scrollbar');
        ...
        $interval(function () {
            ...
            if (_loadNext) {
                _loadNext = false;
                $http.post('http://imadevelopers.com/esn/chats/loadNext.json', $formData, {withCredentials: true})
                    .success(function (data) {
        ...
        $scope.loadPrevious = function () {
            ...
            $http.post('http://imadevelopers.com/esn/chats/loadPrevious.json', $formData, {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
                        var $messages = data.result.messages;
                        for (var i = 0; i < $messages.length; i++) {
        ...
        $scope.deleteMessage = function ($message_id, $index) {
            ...
            $http.delete('http://imadevelopers.com/esn/chats/deleteMessage/' + $message_id + '.json', {withCredentials: true})
                .success(function (data) {
                    if (data.result.success) {
