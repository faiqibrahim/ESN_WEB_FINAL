...
<?php echo $this->Form->create('GroupUser'); ?>
	...
	<?php
		...
		echo $this->Form->input('grouprole_id');
	?>
	</fieldset>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('GroupUser.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('GroupUser.id'))); ?></li>
