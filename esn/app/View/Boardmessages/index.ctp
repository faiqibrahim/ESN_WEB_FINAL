<div class="boardmessages index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('generated'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($boardmessage['Boardmessage']['message']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($boardmessage['Boardmessage']['generated']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $boardmessage['Boardmessage']['id']), array(), __('Are you sure you want to delete # %s?', $boardmessage['Boardmessage']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
