<div class="contenttypes index">
	<h2><?php echo __('Contenttypes'); ?></h2>
	...
	<tr>
		...
		<td><?php echo h($contenttype['Contenttype']['type']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $contenttype['Contenttype']['id']), array(), __('Are you sure you want to delete # %s?', $contenttype['Contenttype']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
