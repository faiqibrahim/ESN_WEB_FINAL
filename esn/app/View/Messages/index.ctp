<div class="messages index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('user_id1'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($message['Message']['user_id1']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $message['Message']['id']), array(), __('Are you sure you want to delete # %s?', $message['Message']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
